...
let rm1 = document.querySelector("hr")
rm1.remove()
...
let p3 = document.createElement("p").innerText="prepend inserts as first child"
document.querySelector(".three").prepend(p3)
...
let box =(document.querySelector(".archive").children)
let boxArray = Array.from(box)
console.log(boxArray)
for (let i = 1; i < boxArray.length; i++){
  if (i % 2 !== 0){
    boxArray[i].style.backgroundColor = "aliceblue"
  }
}
...
imgElm.setAttribute("src" ,`	https://iso.500px.com/wp-content/uploads/2016/11/stock-photo-159533631-1500x1000.jpg`)
console.log(imgElm)
...
document.querySelector("img").style.width ="100%",height ="100%"
